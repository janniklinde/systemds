...
/**
 * OOC-local unsynchronized data output stream with cheap logical and flushed
 * byte positions. This mirrors the write format of FastBufferedDataOutputStream
 * while exposing the positions needed by OOC spill bookkeeping.
 */
