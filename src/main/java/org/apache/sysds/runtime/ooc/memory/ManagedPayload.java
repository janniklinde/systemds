...
public final class ManagedPayload<T> {
	...
	/**
	 * Marks this payload as transferred into the cache. The reservation stays charged to {@link #owner()} and is now
	 * managed through cache pin/unpin.
	 *
	...
	/**
	 * Releases the detached reservation back to the owning allowance if the payload has not been transferred.
	 */
	public void release() {
