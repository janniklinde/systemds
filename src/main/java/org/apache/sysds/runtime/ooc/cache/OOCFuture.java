...
/**
 * Small single-completion future for OOC hot paths. It supports multiple synchronous subscribers without
 * the completion-stage graph and executor machinery of {@link java.util.concurrent.CompletableFuture}.
 */
